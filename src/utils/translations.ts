export const translations = {
  en: {
    ...
    spotTradingDescription: 'Buy and hold assets, no leverage',
    futuresTrading: 'Futures Trading',
    futuresTradingDescription: 'Long/short positions with leverage',
    spotModeInfo: 'Spot mode: Only BUY trades allowed, no leverage, actual asset ownership',
    futuresModeInfo: 'Futures mode: Both LONG/SHORT positions, leverage available, margin trading',
  ...
  tr: {
    ...
    tradeMode: 'Ticaret Modu',
    spotTrading: 'Spot Ticaret',
    spotTradingDescription: 'Varlık satın al ve tut, kaldıraç yok',
    futuresTrading: 'Vadeli İşlem',
    futuresTradingDescription: 'Uzun/kısa pozisyonlar, kaldıraçlı',
    spotModeInfo: 'Spot modu: Sadece SATIN AL işlemleri, kaldıraç yok, gerçek varlık sahipliği',
    futuresModeInfo: 'Vadeli işlem modu: Hem UZUN/KISA pozisyonlar, kaldıraç mevcut, marjin ticareti',
